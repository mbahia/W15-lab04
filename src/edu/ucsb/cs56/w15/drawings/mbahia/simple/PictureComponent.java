package edu.ucsb.cs56.w15.drawings.mbahia.simple;
...
/**
   ...
   @author Manpreet Bahia (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Manpreet Bahia", 20,40);
    }
