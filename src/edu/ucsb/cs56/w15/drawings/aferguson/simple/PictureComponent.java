package edu.ucsb.cs56.w15.drawings.aferguson.simple;
...
/**
   ...
   @author Andrew Ferguson (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Andrew Ferguson", 20,40);
    }
