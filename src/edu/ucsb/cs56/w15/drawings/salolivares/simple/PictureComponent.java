package edu.ucsb.cs56.w15.drawings.salolivares.simple;
...
/**
   ...
   @author Sal Olivares (fixed the snowmans's head)
...
{  
   ...
   {  
      ...
      Circle snowManMiddleCircle = 
       ...
       g2.drawString("Top of snowman added by Sal Olivares", 20,40);
    }
