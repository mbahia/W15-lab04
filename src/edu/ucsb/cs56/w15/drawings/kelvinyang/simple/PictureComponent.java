package edu.ucsb.cs56.w15.drawings.kelvinyang.simple;
...
/**
   ...
   @author Kelvin Yang (fixed the snowmans's head)
...
{  
   ...
   {  
	...
	g2.draw(snowManTopCircle);
       ...
       g2.drawString("Top of snowman added by Kelvin Yang", 20,40);
    }
